                    ...
                    <li key={yearData.year} className="my-3">
                      <div className="flex items-center">
                        <button 
                          ...
                          aria-label={isExpanded ? `Collapse ${yearData.year}` : `Expand ${yearData.year}`}
                        ...
                        {isYearSelected && !selected.month ? (
                          ...
                          <Link
                            ...
                            className={`hover:text-primary-500 dark:hover:text-primary-500 px-2 py-1 text-sm font-medium ${
                              isYearSelected ? 'text-primary-500 dark:text-primary-500' : 'text-gray-700 dark:text-gray-300'
                            }`}
                      ...
                      {isExpanded && (
                        <ul className="pl-8 mt-2">
                          {yearData.months.map((monthData) => {
                            ...
                            const isMonthSelected = isYearSelected && selected.month === monthData.month
